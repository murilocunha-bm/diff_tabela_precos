...
# ------------
XLS_TABELA_PRECO_LITORAL = path.join(PASTA_XLS, 'Tabela de Preco Representante Geral (Litoral).xls') 
XLS_TABELA_PRECO_ST = path.join(PASTA_XLS, 'Tabela de Preco Representante Geral.xls') 
XLS_TABELA_PRECO_SP = path.join(PASTA_XLS, 'Tabela Barra Mansa 27-08-2025.xlsx')
XLS_TABELA_CUSTOS = path.join(PASTA_XLS, 'Tabela Barra Mansa 27-08-2025.xlsx')
# ------------
...
MAPA_TABELA_PRECO_NOVO_LITORAL = [
    {
        'nome_xlsx': XLS_TABELA_PRECO_LITORAL,
        'nome_sheet': 'Tabela Base',
        'nome_colunas': ['Codigo', 'Produtos', 'PesoCaixa', 'R$', 'Qtde'],  # colocar as colunas a apagar como: del01, del02, del03...
        'linhas_pular': 5,                                          # inicia em ZERO
        'colunas_ler': 'C:F',
